...
public interface IAdrTasksRepository
{
    ...
    /// </summary>
    /// <param name="record">A task record with document information.</param>
    /// <returns>A stringbuilder containing the text for the document.</returns>
    Task<StringBuilder> GetLayoutAsync(TaskRecord record);

    /// <summary>
    /// Try to locate the metadata for a a task and return it in the <see cref="TaskRecord/> class.
    /// </summary>
    ...
    /// </summary>
    /// <param name="record">The metadata for a task.</param>
