...
public interface IProjectPlanning
{
    ...
    /// <param name="description">The consice description for the task.</param>
    /// <param name="dueDate">The planned due date for the task.</param>
    /// <returns>Response indicating success or failure, with an optional message</returns>
    Task<Response> NewTaskAsync(string title, string description, string? dueDate);

    /// <summary>
    /// Update the task status to a new state.
    /// </summary>
    /// <param name="sourceId">A numeric reference to an existing task.</param>
    /// <param name="status">The new status for the record.</param>
    /// <param name="justification">The expplanation for the new status.</param>
    /// <returns>Response with success / failure an optional message.</returns>
    ...
    /// </summary>
    /// <param name="sortReverse">Show project planning in reverse order (newest first).</param>
    /// <param name="verbose">Show project planning with more details.</param>
    /// <returns>Response with success / failure and the requested list.</returns>
    ...
    /// <param name="status">Only include tasks with the requested status, ignored for status=None.</param>
    ...
    /// </list>
    /// </summary>
    /// <param name="sourceId">The record that relates another record.</param>
